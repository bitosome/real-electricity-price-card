 ...
 */class lt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let s=r._$litPart$;if(void 0===s){const t=i?.renderBefore??null;r._$litPart$=s=new et(e.insertBefore(T(),t),t,void 0,i??{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}}lt._$litElement$=!0,lt.finalized=!0,ct.litElementHydrateSupport?.({LitElement:lt});const ht=ct.litElementPolyfillSupport;ht?.({LitElement:lt}),(ct.litElementVersions??=[]).push("4.2.2");const dt=o`${n("\n  :host {\n    display: block;\n    /* Chip styling variables */\n    --chip-padding: 2px 2px;\n    --chip-text-font-weight: 700;\n    --chip-text-font-size: var(--chip-font-size, 12px);\n    --chip-background-color: rgba(0,0,0,0.06);\n    --chip-border-radius: var(--ha-badge-border-radius, 999px);\n    --chip-gap: 6px;\n    --main-light-on-bg: linear-gradient(135deg,#ffcf57,#ffb200);\n    --main-light-off-bg: rgba(0,0,0,0.06);\n    --main-light-icon-on-color: #ffffff;\n    --main-light-icon-off-color: var(--secondary-text-color);\n    --switch-on-color: var(--switch-on-yellow, #ffc107);\n    --switch-smart-on-color: var(--switch-on-green, #00c853);\n    --switch-lock-unlocked-color: var(--switch-unlocked-red, #e53935);\n    --switch-chip-bg: var(--chip-background-color, rgba(0,0,0,0.06));\n    --switch-icon-size: 28px;\n    --ac-chip-bg-off: rgba(158,158,158,0.95);\n    --ac-chip-bg-cool: #00aaff;\n    --ac-chip-bg-heat: #ff7043;\n    --ac-chip-bg-dry: #ffca28;\n    --ac-chip-bg-fan: #66bb6a;\n    --ac-chip-bg-auto: #26c6da;\n    --ac-chip-bg-default: rgba(0,0,0,0.06);\n    --ac-chip-icon-color: #ffffff;\n    --ac-chip-icon-off-color: #ffffff;\n    --ac-fan-color-off: gray;\n    --ac-fan-color-cool: #00aaff;\n    --ac-fan-color-heat: #ff7043;\n    --ac-fan-color-dry: #ffca28;\n    --ac-fan-color-fan: #66bb6a;\n    --ac-fan-color-auto: #26c6da;\n    --ac-fan-color-default: var(--paper-item-icon-color);\n    --thermostat-heating-color: #ff7043;\n    --thermostat-idle-color: #66bb6a;\n    --thermostat-off-color: gray;\n    --thermostat-pill-heating-bg: var(--state-climate-heat-color, #ff7043);\n    --thermostat-pill-heating-fg: var(--primary-background-color, #fff);\n    --thermostat-pill-idle-bg: var(--chip-background-color, rgba(0,0,0,0.06));\n    --thermostat-pill-idle-fg: var(--secondary-text-color);\n\n    /* Shared semantic status palette (single source of truth across cards) */\n    --status-on-color: #ffc107;\n    --status-active-color: #42a5f5;\n    --status-success-color: #66bb6a;\n    --status-alert-color: #e53935;\n    --status-warn-color: #ff9800;\n    --status-cool-color: #00aaff;\n    --status-heat-color: #ff7043;\n    --status-dry-color: #ffca28;\n    --status-fan-color: #66bb6a;\n    --status-auto-color: #26c6da;\n    --status-smartplug-on-color: #ff9800;\n    --status-presence-color: #42a5f5;\n    --status-icon-on-color: #ffffff;\n\n    /* Positioning variables */\n    --tile-padding: 8px;\n    --tile-padding-large: 12px;\n    --chip-z-index: 3;\n    --tile-z-index: 2;\n    --glow-z-index: 1;\n\n    /* Tile shape control */\n    --tile-border-radius: var(--ha-card-border-radius, 12px);\n\n    /* Common gaps and spacing */\n    --small-gap: 2px;\n    --medium-gap: 6px;\n    --large-gap: 12px;\n\n    /* Shadow variables */\n    --tile-shadow-default: 0 6px 18px rgba(0,0,0,0.10);\n    --tile-shadow-hover: 0 12px 24px rgba(0,0,0,0.16);\n    --tile-shadow-active: 0 18px 40px var(--pulse-strong, rgba(0,0,0,0.18)), 0 6px 18px var(--pulse-weak, rgba(0,0,0,0.10));\n  }\n")}`,pt="sensor.real_electricity_price_hourly_prices_yesterday",ut="sensor.real_electricity_price_hourly_prices_today",mt="sensor.real_electricity_price_hourly_prices_tomorrow",ft="sensor.real_electricity_price_current_price",gt="number.real_electricity_price_acceptable_price",_t="€/kWh",$t=36e5,bt=48;function yt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}function xt(t,e,i){const r=Number(t);if(Number.isFinite(r))return Math.max(e,Math.min(i,r))}function vt(t){if("number"==typeof t&&Number.isFinite(t))return t;if("string"==typeof t){const e=Number(t);if(Number.isFinite(e))return e;const i=new Date(t).getTime();if(Number.isFinite(i))return i}}function wt(...t){for(const e of t){if(null==e||""===e)continue;const t=Number(e);if(Number.isFinite(t))return t}}function At(t){const e=t?.attributes?.hourly_prices;return Array.isArray(e)?e.reduce((t,e)=>{const i=e,r=Array.isArray(i)?vt(i[0]):vt(i.start_time)??vt(i.x),s=Array.isArray(i)?wt(i[1]):wt(i.actual_price,i.price,i.y,i.nord_pool_price);return void 0===r||void 0===s||t.push({timestamp:r,value:s,sourceTimestamp:r}),t},[]).sort((t,e)=>t.timestamp-e.timestamp):[]}function kt(t){return"line"===(t.chart_type||t.graph_type)?"line":"bar"}function Et(t){return"click"===t.selector_mode?"click":"hover"}function Ct(t){return xt(t.height,120,360)||190}function St(t){return Math.round(xt(t.horizontal_lines,2,9)||5)}function Mt(t){return Math.round(xt(t.price_decimals,0,6)??4)}function Pt(t){return Math.round(xt(t.axis_decimals,0,4)??2)}function Nt(t,e,i=Mt(e)){return void 0!==t&&Number.isFinite(t)?`${t.toFixed(i)} ${e.unit||_t}`:"—"}function Tt(t){const e={hour:"2-digit",minute:"2-digit"},i=String(t?.locale?.time_format||"").toLowerCase();return"12"===i&&(e.hour12=!0),"24"===i&&(e.hour12=!1),e}function Ft(t){const e=t?.config?.time_zone;return"string"==typeof e&&e.trim()?e.trim():void 0}function Ut(t,e,i){const r=Ft(t),s=new Date(e);try{return new Intl.DateTimeFormat(t?.locale?.language,r?{...i,timeZone:r}:i).format(s)}catch{return new Intl.DateTimeFormat(t?.locale?.language,i).format(s)}}function zt(t,e){return`${function(t,e){return Ut(t,e,{day:"numeric",month:"long"})}(t,e)} ${function(t,e){return Ut(t,e,{...Tt(t)})}(t,e)}`}function Ht(t,e,i){return new Intl.DateTimeFormat("en-US",{...i,timeZone:e}).formatToParts(new Date(t)).reduce((t,e)=>("literal"!==e.type&&(t[e.type]=e.value),t),{})}function Ot(t,e){const i=Ht(t,e,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}),r=Number(i.year),s=Number(i.month),n=Number(i.day),o=Number(i.hour),a=Number(i.minute),c=Number(i.second);return[r,s,n,o,a,c].every(Number.isFinite)?Date.UTC(r,s-1,n,o,a,c)-t:0}function Rt(t){const e=new Date;e.setHours(0,0,0,0);const i=function(t){const e=Ft(t);if(e)try{const t=Ht(Date.now(),e,{year:"numeric",month:"2-digit",day:"2-digit"}),i=Number(t.year),r=Number(t.month),s=Number(t.day);if(![i,r,s].every(Number.isFinite))return;const n=Date.UTC(i,r-1,s,0,0,0,0),o=Ot(n,e);return n-Ot(n-o,e)}catch{return}}(t)??e.getTime();return{start:i,end:i+bt*$t}}function It(t,e,i){const r=i.width-i.left-i.right,s=Math.max(1,e.end-e.start);return i.left+(t-e.start)/s*r}function Dt(t,e){if(!t.length)return 0;if(e<=t[0].timestamp)return 0;let i=0;for(let r=1;r<t.length&&!(t[r].timestamp>e);r+=1)i=r;return i}function Lt(t,e){return Math.min(t.timestamp+$t,e.end)}function jt(t,e,i){return It(Lt(t,e),e,i)}function Bt(t,e,i){const r=Lt(t,e);return It(t.timestamp+(r-t.timestamp)/2,e,i)}function Vt(t,e,i,r){const s=t.sourceTimestamp??t.timestamp,n=r>=s&&r<s+$t,o=s+$t<=r,a=void 0!==i&&t.value<=i;return n&&a?e.cheap_current_color||"#22c55e":n?e.current_hour_color||"#3b82f6":o&&a?e.cheap_past_color||"#bbf7d0":o?e.past_color||"#bfdbfe":a?e.cheap_color||"#86efac":e.future_color||"#93c5fd"}function Wt(t){return{yesterday_entity:pt,today_entity:ut,tomorrow_entity:mt,current_price_entity:ft,cheap_price_entity:gt,chart_type:"bar",selector_mode:"hover",height:190,horizontal_lines:5,price_decimals:4,axis_decimals:2,unit:_t,show_current_marker:!0,show_extremes:!0,show_stats:!0,fill_color:"rgba(56, 199, 243, 0.18)",marker_color:"#38c7f3",grid_color:"rgba(255, 255, 255, 0.14)",chart_background:"rgba(33, 52, 62, 0.88)",card_background:"var(--ha-card-background, var(--card-background-color, #1f1f1f))",...t}}class qt extends lt{constructor(){super(...arguments),this._dragging=!1,this._stopPointer=t=>{this._dragging=!1;try{t.currentTarget.releasePointerCapture(t.pointerId)}catch{}}}static async getConfigElement(){return await customElements.whenDefined("real-electricity-price-card-editor"),document.createElement("real-electricity-price-card-editor")}static getStubConfig(){return{type:"custom:real-electricity-price-card",yesterday_entity:pt,today_entity:ut,tomorrow_entity:mt,current_price_entity:ft,chart_type:"bar"}}setConfig(t){this._config=Wt(t||{})}connectedCallback(){super.connectedCallback(),this._clockTimer=window.setInterval(()=>this.requestUpdate(),3e4)}disconnectedCallback(){void 0!==this._clockTimer&&(window.clearInterval(this._clockTimer),this._clockTimer=void 0),super.disconnectedCallback()}getCardSize(){const t=Ct(this._config||{});return Math.max(3,Math.ceil((t+150)/50))}render(){if(!this._config)return V``;const t=Wt(this._config),e=Rt(this.hass),i=function(t,e,i){const r=e.yesterday_entity||pt,s=e.today_entity||ut,n=e.tomorrow_entity||mt,o=t?.states[r],a=t?.states[s],c=t?.states[n],l=[...At(o),...At(a),...At(c)].reduce((t,e)=>(e.timestamp>=i.start&&e.timestamp<i.end&&t.set(e.timestamp,e),t),new Map),h=[a?void 0:s,c?void 0:n].filter(t=>Boolean(t));return{points:[...l.values()].sort((t,e)=>t.timestamp-e.timestamp),moreInfoEntityId:a?s:c?n:void 0,missingEntityIds:h}}(this.hass,t,e);if(!i.points.length){const t=i.missingEntityIds.length?` Missing: ${i.missingEntityIds.join(", ")}`:"";return this._renderError(`No hourly_prices found.${t}`)}const r=kt(t),s=Et(t),n="string"==typeof t.name?t.name.trim():"",o={width:360,height:Ct(t),left:8,right:34,top:15,bottom:24},a=i.points,c=function(t,e){const i=t.map(t=>t.value),r=Math.min(...i),s=Math.max(...i),n=Number(e.min),o=Number(e.max);let a=Number.isFinite(n)?n:Math.min(0,r),c=Number.isFinite(o)?o:s;const l=Math.max(.08*(c-a),.005);return Number.isFinite(n)||(a-=r<0?l:0),Number.isFinite(o)||(c+=l),c<=a&&(c=a+.01),{min:a,max:c}}(a,t),l=function(t,e,i,r){const s=e.height-e.top-e.bottom;return t.map(t=>({...t,x:It(t.timestamp,r,e),y:e.top+(i.max-t.value)/(i.max-i.min)*s}))}(a,o,c,e),h=Date.now(),d=void 0!==this._selectedIndex,p=Math.max(0,Math.min(l.length-1,d?this._selectedIndex??0:Dt(l,h))),u=d?function(t,e,i){return{...t,timestamp:t.sourceTimestamp??t.timestamp,x:Bt(t,e,i),sourceTimestamp:t.sourceTimestamp??t.timestamp}}(l[p],e,o):function(t,e,i,r){const s=t[function(t,e){if(!t.length)return 0;const i=t=>t.sourceTimestamp??t.timestamp;if(e<=i(t[0]))return 0;let r=0;for(let s=1;s<t.length&&!(i(t[s])>e);s+=1)r=s;return r}(t,e)];return e<i.start||e>i.end?s:{...s,timestamp:e,x:It(e,i,r),sourceTimestamp:s.sourceTimestamp??s.timestamp}}(l,h,e,o),m=l.reduce((t,e)=>e.value<t.value?e:t,l[0]),f=l.reduce((t,e)=>e.value>t.value?e:t,l[0]),g=function(t,e){const i=e.current_price_entity||ft,r=t?.states[i]?.state,s=Number(r);return Number.isFinite(s)?s:void 0}(this.hass,t),_=function(t,e){const i=Number(e.cheap_threshold);if(Number.isFinite(i))return i;const r=e.cheap_price_entity||gt;return wt(t?.states[r]?.state)}(this.hass,t),$=i.moreInfoEntityId||t.current_price_entity||ft;return V`
    ...
    `}_renderChart(t,e,i,r,s,n,o,a,c,l,h,d){const p=e.height-e.bottom,u=Math.max(e.top,Math.min(p,e.top+(o.max-0)/(o.max-o.min)*(e.height-e.top-e.bottom))),m=(e.width-e.left-e.right)/bt,f=Math.max(2,Math.min(14,.9*m)),g=function(t){return[0,bt/3,2*bt/3,bt].map(e=>t.start+e*$t)}(l),_=It(Date.now(),l,e),$=!1!==t.show_current_marker&&_>=e.left&&_<=e.width-e.right,b=Bt(s,l,e),y=Bt(n,l,e),x="rep-line-fill",v="rep-line-color",w=Math.max(1,e.width-e.left-e.right),A=i.flatMap(i=>{const r=Vt(i,t,h,d),s=Math.max(0,Math.min(100,(i.x-e.left)/w*100)),n=Math.max(0,Math.min(100,(jt(i,l,e)-e.left)/w*100));return[W`<stop offset=${`${s}%`} stop-color=${r}></stop>`,W`<stop offset=${`${n}%`} stop-color=${r}></stop>`]});return V`
      <svg
        class="price-chart"
      ...
      >
        ...
        ${"line"===a?this._renderLineChart(i,p,x,v,l,e):this._renderBarChart(i,u,f,m,r,t,h,d)}
        ...
        <desc>${i.length} available hourly electricity price points in a fixed ${bt}-hour chart window.</desc>
      </svg>
    `}_renderGrid(t,e,i,r,s){const n=e.height-e.bottom,o=St(t);return[...Array.from({length:o},(r,s)=>{const a=1-s/(o-1),c=e.top+s/(o-1)*(n-e.top),l=i.min+(i.max-i.min)*a;return W`
        ...
        `}),...r.map((t,i)=>{const o=It(t,s,e),a=0===i?" price-time-label-start":i===r.length-1?" price-time-label-end":"";return W`
        ...
        <rect
          ...
          fill=${Vt(t,n,o,a)}
        ></rect>
      `})}_renderLineChart(t,e,i,r,s,n){const o=function(t,e,i,r){const s=[];let n,o="",a=0,c=0;const l=()=>{o&&(s.push({line:o,area:`${o} L ${c.toFixed(2)} ${e.toFixed(2)} L ${a.toFixed(2)} ${e.toFixed(2)} Z`}),o="")};return t.forEach(t=>{const e=t.x,s=jt(t,i,r),h=n&&Math.abs(t.timestamp-(n.timestamp+$t))<6e4;o&&h?o+=` L ${e.toFixed(2)} ${t.y.toFixed(2)}`:(l(),a=e,o=`M ${e.toFixed(2)} ${t.y.toFixed(2)}`),o+=` L ${s.toFixed(2)} ${t.y.toFixed(2)}`,c=s,n=t}),l(),s}(t,e,s,n);return W`
  ...
  `];class Gt extends lt{constructor(){super(...arguments),this._config=qt.getStubConfig()}setConfig(t){this._config=Wt(t||{})}render(){const t=Wt(this._config);return V`
      <div class="editor">
        ${this._textField("Name (optional)","name",t.name||"")}
        ${this._textField("Yesterday Prices Entity","yesterday_entity",t.yesterday_entity||pt)}
        <div class="grid">
          ${this._textField("Today Prices Entity","today_entity",t.today_entity||ut)}
          ${this._textField("Tomorrow Prices Entity","tomorrow_entity",t.tomorrow_entity||mt)}
        </div>
        ${this._textField("Current Price Entity","current_price_entity",t.current_price_entity||ft)}
        ${this._textField("Acceptable Price Entity","cheap_price_entity",t.cheap_price_entity||gt)}
        <label>
    ...
    `}_setValue(t,e){const i={...this._config};void 0===e||""===e?delete i[t]:i[t]=e,this._config=i,yt(this,"config-changed",{config:i})}}Gt.properties={hass:{attribute:!1},_config:{state:!0}},Gt.styles=o`
    :host {
      display: block;
    }
