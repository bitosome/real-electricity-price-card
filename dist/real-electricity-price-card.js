 ...
 */class lt extends v{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let s=r._$litPart$;if(void 0===s){const t=i?.renderBefore??null;r._$litPart$=s=new et(e.insertBefore(F(),t),t,void 0,i??{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return q}}lt._$litElement$=!0,lt.finalized=!0,ct.litElementHydrateSupport?.({LitElement:lt});const ht=ct.litElementPolyfillSupport;ht?.({LitElement:lt}),(ct.litElementVersions??=[]).push("4.2.2");const dt=o`${n("\n  :host {\n    display: block;\n    /* Chip styling variables */\n    --chip-padding: 2px 2px;\n    --chip-text-font-weight: 700;\n    --chip-text-font-size: var(--chip-font-size, 12px);\n    --chip-background-color: rgba(0,0,0,0.06);\n    --chip-border-radius: var(--ha-badge-border-radius, 999px);\n    --chip-gap: 6px;\n    --main-light-on-bg: linear-gradient(135deg,#ffcf57,#ffb200);\n    --main-light-off-bg: rgba(0,0,0,0.06);\n    --main-light-icon-on-color: #ffffff;\n    --main-light-icon-off-color: var(--secondary-text-color);\n    --switch-on-color: var(--switch-on-yellow, #ffc107);\n    --switch-smart-on-color: var(--switch-on-green, #00c853);\n    --switch-lock-unlocked-color: var(--switch-unlocked-red, #e53935);\n    --switch-chip-bg: var(--chip-background-color, rgba(0,0,0,0.06));\n    --switch-icon-size: 28px;\n    --ac-chip-bg-off: rgba(158,158,158,0.95);\n    --ac-chip-bg-cool: #00aaff;\n    --ac-chip-bg-heat: #ff7043;\n    --ac-chip-bg-dry: #ffca28;\n    --ac-chip-bg-fan: #66bb6a;\n    --ac-chip-bg-auto: #26c6da;\n    --ac-chip-bg-default: rgba(0,0,0,0.06);\n    --ac-chip-icon-color: #ffffff;\n    --ac-chip-icon-off-color: #ffffff;\n    --ac-fan-color-off: gray;\n    --ac-fan-color-cool: #00aaff;\n    --ac-fan-color-heat: #ff7043;\n    --ac-fan-color-dry: #ffca28;\n    --ac-fan-color-fan: #66bb6a;\n    --ac-fan-color-auto: #26c6da;\n    --ac-fan-color-default: var(--paper-item-icon-color);\n    --thermostat-heating-color: #ff7043;\n    --thermostat-idle-color: #66bb6a;\n    --thermostat-off-color: gray;\n    --thermostat-pill-heating-bg: var(--state-climate-heat-color, #ff7043);\n    --thermostat-pill-heating-fg: var(--primary-background-color, #fff);\n    --thermostat-pill-idle-bg: var(--chip-background-color, rgba(0,0,0,0.06));\n    --thermostat-pill-idle-fg: var(--secondary-text-color);\n\n    /* Shared semantic status palette (single source of truth across cards) */\n    --status-on-color: #ffc107;\n    --status-active-color: #42a5f5;\n    --status-success-color: #66bb6a;\n    --status-alert-color: #e53935;\n    --status-warn-color: #ff9800;\n    --status-cool-color: #00aaff;\n    --status-heat-color: #ff7043;\n    --status-dry-color: #ffca28;\n    --status-fan-color: #66bb6a;\n    --status-auto-color: #26c6da;\n    --status-smartplug-on-color: #ff9800;\n    --status-presence-color: #42a5f5;\n    --status-icon-on-color: #ffffff;\n\n    /* Positioning variables */\n    --tile-padding: 8px;\n    --tile-padding-large: 12px;\n    --chip-z-index: 3;\n    --tile-z-index: 2;\n    --glow-z-index: 1;\n\n    /* Tile shape control */\n    --tile-border-radius: var(--ha-card-border-radius, 12px);\n\n    /* Common gaps and spacing */\n    --small-gap: 2px;\n    --medium-gap: 6px;\n    --large-gap: 12px;\n\n    /* Shadow variables */\n    --tile-shadow-default: 0 6px 18px rgba(0,0,0,0.10);\n    --tile-shadow-hover: 0 12px 24px rgba(0,0,0,0.16);\n    --tile-shadow-active: 0 18px 40px var(--pulse-strong, rgba(0,0,0,0.18)), 0 6px 18px var(--pulse-weak, rgba(0,0,0,0.10));\n  }\n")}`,pt="sensor.real_electricity_price_hourly_prices_today",ut="sensor.real_electricity_price_hourly_prices_tomorrow",mt="sensor.real_electricity_price_current_price",ft="number.real_electricity_price_acceptable_price",gt="€/kWh",_t=36e5,$t=48;function bt(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}function xt(t,e,i){const r=Number(t);if(Number.isFinite(r))return Math.max(e,Math.min(i,r))}function yt(t){if("number"==typeof t&&Number.isFinite(t))return t;if("string"==typeof t){const e=Number(t);if(Number.isFinite(e))return e;const i=new Date(t).getTime();if(Number.isFinite(i))return i}}function vt(...t){for(const e of t){if(null==e||""===e)continue;const t=Number(e);if(Number.isFinite(t))return t}}function wt(t){const e=t?.attributes?.hourly_prices;return Array.isArray(e)?e.reduce((t,e)=>{const i=e,r=Array.isArray(i)?yt(i[0]):yt(i.start_time)??yt(i.x),s=Array.isArray(i)?vt(i[1]):vt(i.actual_price,i.price,i.y,i.nord_pool_price);return void 0===r||void 0===s||t.push({timestamp:r,value:s,sourceTimestamp:r}),t},[]).sort((t,e)=>t.timestamp-e.timestamp):[]}function At(t,e){const i=[...t].sort((t,e)=>t.timestamp-e.timestamp),r=e+864e5;for(let t=0;t<=i.length-24;t+=1){const s=i.slice(t,t+24),n=It(s[0].timestamp,e+_t),o=It(s[s.length-1].timestamp,r);if(n&&o)return s.map((t,i)=>({...t,sourceTimestamp:t.timestamp,timestamp:e+i*_t}))}return i.filter(t=>t.timestamp>=e&&t.timestamp<r)}function kt(t){return"line"===(t.chart_type||t.graph_type)?"line":"bar"}function Et(t){return"click"===t.selector_mode?"click":"hover"}function Ct(t){return xt(t.height,120,360)||190}function St(t){return Math.round(xt(t.horizontal_lines,2,9)||5)}function Mt(t){return Math.round(xt(t.price_decimals,0,6)??4)}function Pt(t){return Math.round(xt(t.axis_decimals,0,4)??2)}function Nt(t,e,i=Mt(e)){return void 0!==t&&Number.isFinite(t)?`${t.toFixed(i)} ${e.unit||gt}`:"—"}function Ft(t){const e={hour:"2-digit",minute:"2-digit"},i=String(t?.locale?.time_format||"").toLowerCase();return"12"===i&&(e.hour12=!0),"24"===i&&(e.hour12=!1),e}function Tt(t){const e=t?.config?.time_zone;return"string"==typeof e&&e.trim()?e.trim():void 0}function Ut(t,e,i){const r=Tt(t),s=new Date(e);try{return new Intl.DateTimeFormat(t?.locale?.language,r?{...i,timeZone:r}:i).format(s)}catch{return new Intl.DateTimeFormat(t?.locale?.language,i).format(s)}}function zt(t,e){return`${function(t,e){return Ut(t,e,{day:"numeric",month:"long"})}(t,e)} ${function(t,e){return Ut(t,e,{...Ft(t)})}(t,e)}`}function Ht(t,e,i){return new Intl.DateTimeFormat("en-US",{...i,timeZone:e}).formatToParts(new Date(t)).reduce((t,e)=>("literal"!==e.type&&(t[e.type]=e.value),t),{})}function Ot(t,e){const i=Ht(t,e,{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit",hourCycle:"h23"}),r=Number(i.year),s=Number(i.month),n=Number(i.day),o=Number(i.hour),a=Number(i.minute),c=Number(i.second);return[r,s,n,o,a,c].every(Number.isFinite)?Date.UTC(r,s-1,n,o,a,c)-t:0}function Rt(t){const e=new Date;e.setHours(0,0,0,0);const i=function(t){const e=Tt(t);if(e)try{const t=Ht(Date.now(),e,{year:"numeric",month:"2-digit",day:"2-digit"}),i=Number(t.year),r=Number(t.month),s=Number(t.day);if(![i,r,s].every(Number.isFinite))return;const n=Date.UTC(i,r-1,s,0,0,0,0),o=Ot(n,e);return n-Ot(n-o,e)}catch{return}}(t)??e.getTime();return{start:i,end:i+$t*_t}}function It(t,e){return Math.abs(t-e)<6e4}function Dt(t,e,i){const r=i.width-i.left-i.right,s=Math.max(1,e.end-e.start);return i.left+(t-e.start)/s*r}function Lt(t,e){if(!t.length)return 0;if(e<=t[0].timestamp)return 0;let i=0;for(let r=1;r<t.length&&!(t[r].timestamp>e);r+=1)i=r;return i}function jt(t){if(!t.length)return"";if(1===t.length)return`M ${t[0].x.toFixed(2)} ${t[0].y.toFixed(2)}`;let e=`M ${t[0].x.toFixed(2)} ${t[0].y.toFixed(2)}`;for(let i=0;i<t.length-1;i+=1){const r=t[i],s=t[i+1],n=t[i-1]||r,o=t[i+2]||s,a=r.x+(s.x-n.x)/6,c=r.y+(s.y-n.y)/6,l=s.x-(o.x-r.x)/6,h=s.y-(o.y-r.y)/6;e+=` C ${a.toFixed(2)} ${c.toFixed(2)}, ${l.toFixed(2)} ${h.toFixed(2)}, ${s.x.toFixed(2)} ${s.y.toFixed(2)}`}return e}function Bt(t,e,i,r){const s=t.sourceTimestamp??t.timestamp,n=r>=s&&r<s+_t,o=s+_t<=r,a=void 0!==i&&t.value<=i;return n&&a?e.cheap_current_color||"#22c55e":n?e.current_hour_color||"#3b82f6":o&&a?e.cheap_past_color||"#bbf7d0":o?e.past_color||"#bfdbfe":a?e.cheap_color||"#86efac":e.future_color||"#93c5fd"}function Vt(t){return{today_entity:pt,tomorrow_entity:ut,current_price_entity:mt,cheap_price_entity:ft,chart_type:"bar",selector_mode:"hover",height:190,horizontal_lines:5,price_decimals:4,axis_decimals:2,unit:gt,show_current_marker:!0,show_extremes:!0,show_stats:!0,fill_color:"rgba(56, 199, 243, 0.18)",marker_color:"#38c7f3",grid_color:"rgba(255, 255, 255, 0.14)",chart_background:"rgba(33, 52, 62, 0.88)",card_background:"var(--ha-card-background, var(--card-background-color, #1f1f1f))",...t}}class Wt extends lt{constructor(){super(...arguments),this._dragging=!1,this._stopPointer=t=>{this._dragging=!1;try{t.currentTarget.releasePointerCapture(t.pointerId)}catch{}}}static async getConfigElement(){return await customElements.whenDefined("real-electricity-price-card-editor"),document.createElement("real-electricity-price-card-editor")}static getStubConfig(){return{type:"custom:real-electricity-price-card",today_entity:pt,tomorrow_entity:ut,current_price_entity:mt,chart_type:"bar"}}setConfig(t){this._config=Vt(t||{})}connectedCallback(){super.connectedCallback(),this._clockTimer=window.setInterval(()=>this.requestUpdate(),3e4)}disconnectedCallback(){void 0!==this._clockTimer&&(window.clearInterval(this._clockTimer),this._clockTimer=void 0),super.disconnectedCallback()}getCardSize(){const t=Ct(this._config||{});return Math.max(3,Math.ceil((t+150)/50))}render(){if(!this._config)return V``;const t=Vt(this._config),e=Rt(this.hass),i=function(t,e,i){const r=e.today_entity||pt,s=e.tomorrow_entity||ut,n=t?.states[r],o=t?.states[s],a=At(wt(n),i.start),c=At(wt(o),i.start+864e5),l=[n?void 0:r,o?void 0:s].filter(t=>Boolean(t));return{points:[...a,...c].sort((t,e)=>t.timestamp-e.timestamp),moreInfoEntityId:n?r:o?s:void 0,missingEntityIds:l}}(this.hass,t,e);if(!i.points.length){const t=i.missingEntityIds.length?` Missing: ${i.missingEntityIds.join(", ")}`:"";return this._renderError(`No hourly_prices found.${t}`)}const r=kt(t),s=Et(t),n="string"==typeof t.name?t.name.trim():"",o={width:360,height:Ct(t),left:8,right:34,top:15,bottom:24},a=i.points,c=function(t,e){const i=t.map(t=>t.value),r=Math.min(...i),s=Math.max(...i),n=Number(e.min),o=Number(e.max);let a=Number.isFinite(n)?n:Math.min(0,r),c=Number.isFinite(o)?o:s;const l=Math.max(.08*(c-a),.005);return Number.isFinite(n)||(a-=r<0?l:0),Number.isFinite(o)||(c+=l),c<=a&&(c=a+.01),{min:a,max:c}}(a,t),l=function(t,e,i,r){const s=e.height-e.top-e.bottom;return t.map(t=>({...t,x:Dt(t.timestamp,r,e),y:e.top+(i.max-t.value)/(i.max-i.min)*s}))}(a,o,c,e),h=(o.width-o.left-o.right)/$t,d=Date.now(),p=void 0!==this._selectedIndex,u=Math.max(0,Math.min(l.length-1,p?this._selectedIndex??0:Lt(l,d))),m=p?"bar"===r?function(t,e){return{...t,x:t.x+e/2,sourceTimestamp:t.sourceTimestamp??t.timestamp}}(l[u],h):l[u]:function(t,e,i,r){const s=t[function(t,e){if(!t.length)return 0;const i=t=>t.sourceTimestamp??t.timestamp;if(e<=i(t[0]))return 0;let r=0;for(let s=1;s<t.length&&!(i(t[s])>e);s+=1)r=s;return r}(t,e)];return e<i.start||e>i.end?s:{...s,timestamp:e,x:Dt(e,i,r),sourceTimestamp:s.sourceTimestamp??s.timestamp}}(l,d,e,o),f=l.reduce((t,e)=>e.value<t.value?e:t,l[0]),g=l.reduce((t,e)=>e.value>t.value?e:t,l[0]),_=function(t,e){const i=e.current_price_entity||mt,r=t?.states[i]?.state,s=Number(r);return Number.isFinite(s)?s:void 0}(this.hass,t),$=function(t,e){const i=Number(e.cheap_threshold);if(Number.isFinite(i))return i;const r=e.cheap_price_entity||ft;return vt(t?.states[r]?.state)}(this.hass,t),b=i.moreInfoEntityId||t.current_price_entity||mt;return V`
        ...
        <div class="price-content">
          ${n?V`
            <div class="price-head">
              <button class="price-title" @click=${()=>this._openMoreInfo(b)}>
                <span>${n}</span>
              </button>
            </div>
          `:G}

          ${!1===t.show_stats?G:this._renderStats(t,a,f,g,_)}

          <div class="price-chart-frame">
            <div class="price-chart-head">
              <div class="price-selected">
                <span>${zt(this.hass,m.timestamp)}</span>
                <strong>${Nt(m.value,t)}</strong>
              </div>
            </div>
            <div class="price-chart-body">
              ${this._renderChart(t,o,l,m,f,g,c,r,s,e,$,d)}
              <span
    ...
    `}_renderChart(t,e,i,r,s,n,o,a,c,l,h,d){const p=e.height-e.bottom,u=Math.max(e.top,Math.min(p,e.top+(o.max-0)/(o.max-o.min)*(e.height-e.top-e.bottom))),m=(e.width-e.left-e.right)/$t,f=Math.max(2,Math.min(14,.9*m)),g=function(t){return[0,$t/3,2*$t/3,$t].map(e=>t.start+e*_t)}(l),_=Dt(Date.now(),l,e),$=!1!==t.show_current_marker&&_>=e.left&&_<=e.width-e.right,b="bar"===a?s.x+m/2:s.x,x="bar"===a?n.x+m/2:n.x,y="rep-line-fill",v="rep-line-color",w=Math.max(1,e.width-e.left-e.right);return V`
      <svg
        class="price-chart"
      ...
      >
        <defs>
          ...
          <linearGradient id=${v} x1=${e.left} x2=${e.width-e.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
            ${i.map(i=>W`
              <stop offset=${`${Math.max(0,Math.min(100,(i.x-e.left)/w*100))}%`} stop-color=${Bt(i,t,h,d)}></stop>
            `)}
          </linearGradient>
        </defs>
        ${this._renderGrid(t,e,o,g,l)}
        ${"line"===a?this._renderLineChart(i,p,y,v,t):this._renderBarChart(i,u,f,m,r,t,h,d)}
        ${$?W`<line class="price-current-line" x1=${_} x2=${_} y1=${e.top} y2=${p}></line>`:G}
    ...
    `}_renderGrid(t,e,i,r,s){const n=e.height-e.bottom,o=St(t);return[...Array.from({length:o},(r,s)=>{const a=1-s/(o-1),c=e.top+s/(o-1)*(n-e.top),l=i.min+(i.max-i.min)*a;return W`
        ...
        `})]}_renderBarChart(t,e,i,r,s,n,o,a){const c=s.timestamp,l=s.sourceTimestamp,h=Math.max(0,(r-i)/2);return t.map(t=>{const r=Math.min(t.y,e),s=Math.max(1,Math.abs(e-t.y)),d=t.timestamp===c||void 0!==l&&t.sourceTimestamp===l?" price-bar-selected":"";return W`
        <rect
          class=${`price-bar${d}`}
          x=${t.x+h}
          y=${r}
          ...
          fill=${Bt(t,n,o,a)}
        ></rect>
      `})}_renderLineChart(t,e,i,r,s){const n=jt(t),o=function(t,e){if(!t.length)return"";const i=t[0],r=t[t.length-1];return`${jt(t)} L ${r.x.toFixed(2)} ${e.toFixed(2)} L ${i.x.toFixed(2)} ${e.toFixed(2)} Z`}(t,e);return W`
  ...
  `];class qt extends lt{constructor(){super(...arguments),this._config=Wt.getStubConfig()}setConfig(t){this._config=Vt(t||{})}render(){const t=Vt(this._config);return V`
      <div class="editor">
        ${this._textField("Name (optional)","name",t.name||"")}
        <div class="grid">
          ${this._textField("Today Prices Entity","today_entity",t.today_entity||pt)}
    ...
    `}_setValue(t,e){const i={...this._config};void 0===e||""===e?delete i[t]:i[t]=e,this._config=i,bt(this,"config-changed",{config:i})}}qt.properties={hass:{attribute:!1},_config:{state:!0}},qt.styles=o`
    :host {
      display: block;
    }
