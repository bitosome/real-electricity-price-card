 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const v=globalThis,w=t=>t,A=v.trustedTypes,E=A?A.createPolicy("lit-html",{createHTML:t=>t}):void 0,C="$lit$",k=`lit$${Math.random().toFixed(9).slice(2)}$`,S="?"+k,M=`<${S}>`,P=document,F=()=>P.createComment(""),N=t=>null===t||"object"!=typeof t&&"function"!=typeof t,U=Array.isArray,O="[ \t\n\f\r]",T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,H=/-->/g,z=/>/g,R=RegExp(`>|${O}(?:([^\\s"'>=/]+)(${O}*=${O}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,L=/"/g,I=/^(?:script|style|textarea|title)$/i,j=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),B=j(1),V=j(2),W=Symbol.for("lit-noChange"),G=Symbol.for("lit-nothing"),q=new WeakMap,J=P.createTreeWalker(P,129);function Z(t,e){if(!U(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==E?E.createHTML(e):e}const K=(t,e)=>{const i=t.length-1,r=[];let s,o=2===e?"<svg>":3===e?"<math>":"",n=T;for(let e=0;e<i;e++){const i=t[e];let a,c,l=-1,h=0;for(;h<i.length&&(n.lastIndex=h,c=n.exec(i),null!==c);)h=n.lastIndex,n===T?"!--"===c[1]?n=H:void 0!==c[1]?n=z:void 0!==c[2]?(I.test(c[2])&&(s=RegExp("</"+c[2],"g")),n=R):void 0!==c[3]&&(n=R):n===R?">"===c[0]?(n=s??T,l=-1):void 0===c[1]?l=-2:(l=n.lastIndex-c[2].length,a=c[1],n=void 0===c[3]?R:'"'===c[3]?L:D):n===L||n===D?n=R:n===H||n===z?n=T:(n=R,s=void 0);const d=n===R&&t[e+1].startsWith("/>")?" ":"";o+=n===T?i+M:l>=0?(r.push(a),i.slice(0,l)+C+i.slice(l)+k+d):i+k+(-2===l?e:d)}return[Z(t,o+(t[i]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),r]};class Y{constructor({strings:t,_$litType$:e},i){let r;this.parts=[];let s=0,o=0;const n=t.length-1,a=this.parts,[c,l]=K(t,e);if(this.el=Y.createElement(c,i),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(r=J.nextNode())&&a.length<n;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(C)){const e=l[o++],i=r.getAttribute(t).split(k),n=/([.?@])?(.*)/.exec(e);a.push({type:1,index:s,name:n[2],strings:i,ctor:"."===n[1]?it:"?"===n[1]?rt:"@"===n[1]?st:et}),r.removeAttribute(t)}else t.startsWith(k)&&(a.push({type:6,index:s}),r.removeAttribute(t));if(I.test(r.tagName)){const t=r.textContent.split(k),e=t.length-1;if(e>0){r.textContent=A?A.emptyScript:"";for(let i=0;i<e;i++)r.append(t[i],F()),J.nextNode(),a.push({type:2,index:++s});r.append(t[e],F())}}}else if(8===r.nodeType)if(r.data===S)a.push({type:2,index:s});else{let t=-1;for(;-1!==(t=r.data.indexOf(k,t+1));)a.push({type:7,index:s}),t+=k.length-1}s++}}static createElement(t,e){const i=P.createElement("template");return i.innerHTML=t,i}}function X(t,e,i=t,r){if(e===W)return e;let s=void 0!==r?i._$Co?.[r]:i._$Cl;const o=N(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),void 0===o?s=void 0:(s=new o(t),s._$AT(t,i,r)),void 0!==r?(i._$Co??=[])[r]=s:i._$Cl=s),void 0!==s&&(e=X(t,s._$AS(t,e.values),s,r)),e}class Q{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:i}=this._$AD,r=(t?.creationScope??P).importNode(e,!0);J.currentNode=r;let s=J.nextNode(),o=0,n=0,a=i[0];for(;void 0!==a;){if(o===a.index){let e;2===a.type?e=new tt(s,s.nextSibling,this,t):1===a.type?e=new a.ctor(s,a.name,a.strings,this,t):6===a.type&&(e=new ot(s,this,t)),this._$AV.push(e),a=i[++n]}o!==a?.index&&(s=J.nextNode(),o++)}return J.currentNode=P,r}p(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class tt{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,i,r){this.type=2,this._$AH=G,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=r,this._$Cv=r?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=X(this,t,e),N(t)?t===G||null==t||""===t?(this._$AH!==G&&this._$AR(),this._$AH=G):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>U(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==G&&N(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:i}=t,r="number"==typeof i?this._$AC(t):(void 0===i.el&&(i.el=Y.createElement(Z(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===r)this._$AH.p(e);else{const t=new Q(r,this),i=t.u(this.options);t.p(e),this.T(i),this._$AH=t}}_$AC(t){let e=q.get(t.strings);return void 0===e&&q.set(t.strings,e=new Y(t)),e}k(t){U(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,r=0;for(const s of t)r===e.length?e.push(i=new tt(this.O(F()),this.O(F()),this,this.options)):i=e[r],i._$AI(s),r++;r<e.length&&(this._$AR(i&&i._$AB.nextSibling,r),e.length=r)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=w(t).nextSibling;w(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class et{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,i,r,s){this.type=1,this._$AH=G,this._$AN=void 0,this.element=t,this.name=e,this._$AM=r,this.options=s,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=G}_$AI(t,e=this,i,r){const s=this.strings;let o=!1;if(void 0===s)t=X(this,t,e,0),o=!N(t)||t!==this._$AH&&t!==W,o&&(this._$AH=t);else{const r=t;let n,a;for(t=s[0],n=0;n<s.length-1;n++)a=X(this,r[i+n],e,n),a===W&&(a=this._$AH[n]),o||=!N(a)||a!==this._$AH[n],a===G?t=G:t!==G&&(t+=(a??"")+s[n+1]),this._$AH[n]=a}o&&!r&&this.j(t)}j(t){t===G?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends et{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===G?void 0:t}}class rt extends et{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==G)}}class st extends et{constructor(t,e,i,r,s){super(t,e,i,r,s),this.type=5}_$AI(t,e=this){if((t=X(this,t,e,0)??G)===W)return;const i=this._$AH,r=t===G&&i!==G||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==G&&(i===G||r);r&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ot{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){X(this,t)}}const nt=v.litHtmlPolyfillSupport;nt?.(Y,tt),(v.litHtmlVersions??=[]).push("3.3.3");const at=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ct extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const r=i?.renderBefore??e;let s=r._$litPart$;if(void 0===s){const t=i?.renderBefore??null;r._$litPart$=s=new tt(e.insertBefore(F(),t),t,void 0,i??{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return W}}ct._$litElement$=!0,ct.finalized=!0,at.litElementHydrateSupport?.({LitElement:ct});const lt=at.litElementPolyfillSupport;lt?.({LitElement:ct}),(at.litElementVersions??=[]).push("4.2.2");const ht="sensor.real_electricity_price_chart_data",dt="sensor.real_electricity_price_current_price",pt="€/kWh",ut=36e5,mt=48,_t={"#bfdbfe":"past_color","#3b82f6":"current_hour_color","#93c5fd":"future_color","#bbf7d0":"cheap_past_color","#86efac":"cheap_color","#22c55e":"cheap_current_color"};function ft(t,e,i){t.dispatchEvent(new CustomEvent(e,{detail:i,bubbles:!0,composed:!0}))}function gt(t,e,i){const r=Number(t);if(Number.isFinite(r))return Math.max(e,Math.min(i,r))}function $t(t){if("string"!=typeof t)return;return t.trim()||void 0}function xt(t){if("number"==typeof t&&Number.isFinite(t))return t;if("string"==typeof t){const e=Number(t);if(Number.isFinite(e))return e;const i=new Date(t).getTime();if(Number.isFinite(i))return i}}function yt(t){return"line"===(t.chart_type||t.graph_type)?"line":"bar"}function bt(t){return"click"===t.selector_mode?"click":"hover"}function vt(t){return gt(t.height,120,360)||190}function wt(t){return Math.round(gt(t.horizontal_lines,2,9)||5)}function At(t){return Math.round(gt(t.price_decimals,0,6)??4)}function Et(t){return Math.round(gt(t.axis_decimals,0,4)??2)}function Ct(t,e,i=At(e)){return void 0!==t&&Number.isFinite(t)?`${t.toFixed(i)} ${e.unit||pt}`:"—"}function kt(t){const e={hour:"2-digit",minute:"2-digit"},i=String(t?.locale?.time_format||"").toLowerCase();return"12"===i&&(e.hour12=!0),"24"===i&&(e.hour12=!1),e}function St(t,e){return new Intl.DateTimeFormat(t?.locale?.language,{day:"numeric",month:"long",...kt(t)}).format(new Date(e))}function Mt(t,e,i){const r=i.width-i.left-i.right,s=Math.max(1,e.end-e.start);return i.left+(t-e.start)/s*r}function Pt(t){if(!t.length)return"";if(1===t.length)return`M ${t[0].x.toFixed(2)} ${t[0].y.toFixed(2)}`;let e=`M ${t[0].x.toFixed(2)} ${t[0].y.toFixed(2)}`;for(let i=0;i<t.length-1;i+=1){const r=t[i],s=t[i+1],o=t[i-1]||r,n=t[i+2]||s,a=r.x+(s.x-o.x)/6,c=r.y+(s.y-o.y)/6,l=s.x-(n.x-r.x)/6,h=s.y-(n.y-r.y)/6;e+=` C ${a.toFixed(2)} ${c.toFixed(2)}, ${l.toFixed(2)} ${h.toFixed(2)}, ${s.x.toFixed(2)} ${s.y.toFixed(2)}`}return e}function Ft(t,e){const i=(r=t.color)?r.trim().toLowerCase():void 0;var r;const s=i?e.color_overrides?.[i]||e.color_overrides?.[t.color||""]:void 0;if(s)return s;const o=i?_t[i]:void 0;return o&&$t(e[o])?String(e[o]):!1!==e.use_sensor_colors&&t.color?t.color:e.line_color||"#ffc928"}function Nt(t){return{entity:ht,current_price_entity:dt,chart_type:"bar",selector_mode:"hover",height:190,horizontal_lines:5,price_decimals:4,axis_decimals:2,unit:pt,show_current_marker:!0,show_extremes:!0,show_stats:!0,use_sensor_colors:!0,line_color:"#ffc928",fill_color:"rgba(56, 199, 243, 0.18)",marker_color:"#38c7f3",grid_color:"rgba(255, 255, 255, 0.14)",chart_background:"rgba(33, 52, 62, 0.88)",card_background:"var(--ha-card-background, var(--card-background-color, #1f1f1f))",color_overrides:{},...t}}class Ut extends ct{constructor(){super(...arguments),this._dragging=!1,this._stopPointer=t=>{this._dragging=!1;try{t.currentTarget.releasePointerCapture(t.pointerId)}catch{}}}static async getConfigElement(){return await customElements.whenDefined("real-electricity-price-card-editor"),document.createElement("real-electricity-price-card-editor")}static getStubConfig(){return{type:"custom:real-electricity-price-card",entity:ht,current_price_entity:dt,chart_type:"bar"}}setConfig(t){this._config=Nt(t||{})}getCardSize(){const t=vt(this._config||{});return Math.max(3,Math.ceil((t+150)/50))}render(){if(!this._config)return B``;const t=Nt(this._config),e=t.entity||ht,i=this.hass?.states[e],r=function(t){const e=t?.attributes?.chart_data;return Array.isArray(e)?e.reduce((t,e)=>{const i=e,r=Array.isArray(i)?xt(i[0]):xt(i.x)??xt(i.start_time),s=Number(Array.isArray(i)?i[1]:i.y);return void 0!==r&&Number.isFinite(s)?(t.push({timestamp:r,value:s,color:Array.isArray(i)?void 0:$t(i.fillColor),startTime:Array.isArray(i)?void 0:i.start_time,formattedTime:Array.isArray(i)?void 0:i.formatted_time,formattedPrice:Array.isArray(i)?void 0:i.formatted_price}),t):t},[]).sort((t,e)=>t.timestamp-e.timestamp):[]}(i);if(!i)return this._renderError(`Entity not found: ${e}`);if(!r.length)return this._renderError(`No chart_data found on ${e}`);const s=yt(t),o=bt(t),n="string"==typeof t.name?t.name.trim():"",a={width:360,height:vt(t),left:8,right:34,top:16,bottom:27},c=function(){const t=new Date;t.setHours(0,0,0,0);const e=t.getTime();return{start:e,end:e+mt*ut}}(),l=function(t,e){return t.filter(t=>t.timestamp>=e.start&&t.timestamp<=e.end)}(r,c),h=l.length?l:r,d=function(t,e){const i=t.map(t=>t.value),r=Math.min(...i),s=Math.max(...i),o=Number(e.min),n=Number(e.max);let a=Number.isFinite(o)?o:Math.min(0,r),c=Number.isFinite(n)?n:s;const l=Math.max(.08*(c-a),.005);return Number.isFinite(o)||(a-=r<0?l:0),Number.isFinite(n)||(c+=l),c<=a&&(c=a+.01),{min:a,max:c}}(h,t),p=function(t,e,i,r){const s=e.height-e.top-e.bottom;return t.map(t=>({...t,x:Mt(t.timestamp,r,e),y:e.top+(i.max-t.value)/(i.max-i.min)*s}))}(h,a,d,c),u=Math.max(0,Math.min(p.length-1,this._selectedIndex??function(t,e=Date.now()){if(!t.length)return 0;let i=0,r=Math.abs(t[0].timestamp-e);return t.forEach((t,s)=>{const o=Math.abs(t.timestamp-e);o<r&&(i=s,r=o)}),i}(p))),m=p[u],_=p.reduce((t,e)=>e.value<t.value?e:t,p[0]),f=p.reduce((t,e)=>e.value>t.value?e:t,p[0]),g=function(t,e){const i=e.current_price_entity||dt,r=t?.states[i]?.state,s=Number(r);return Number.isFinite(s)?s:void 0}(this.hass,t);return B`
      <ha-card class="price-card" style=${`--rep-card-bg:${t.card_background};--rep-chart-bg:${t.chart_background};--rep-grid:${t.grid_color};--rep-marker:${t.marker_color};`}>
        <div class="price-content">
          ...
          ${!1===t.show_stats?G:this._renderStats(t,h,_,f,g)}
          ...
          <div class="price-chart-frame">
            <div class="price-chart-head">
              ...
              <div class="price-selected">
                <span>${St(this.hass,m.timestamp)}</span>
                <strong>${Ct(m.value,t)}</strong>
              </div>
            </div>
            <div class="price-chart-body">
              ${this._renderChart(t,a,p,m,_,f,d,s,o,c)}
              <span
                class="price-selected-dot"
                style=${`left:${(m.x/a.width*100).toFixed(2)}%;top:${(m.y/a.height*100).toFixed(2)}%;`}
              ></span>
            </div>
          </div>
        </div>
    ...
    `}_renderChart(t,e,i,r,s,o,n,a,c,l){const h=e.height-e.bottom,d=Math.max(e.top,Math.min(h,e.top+(n.max-0)/(n.max-n.min)*(e.height-e.top-e.bottom))),p=e.width-e.left-e.right,u=Math.max(2,Math.min(14,p/mt*.82)),m=function(t){return[0,mt/3,2*mt/3,mt].map(e=>t.start+e*ut)}(l),_=Mt(Date.now(),l,e),f=!1!==t.show_current_marker&&_>=e.left&&_<=e.width-e.right,g="rep-line-fill",$="rep-line-color",x=Math.max(1,e.width-e.left-e.right);return B`
      <svg
        class="price-chart"
        ...
        @pointerdown=${t=>this._selectPoint(t,i,e,c)}
        @pointermove=${t=>this._selectPoint(t,i,e,c)}
      ...
      >
        <defs>
          ...
          <linearGradient id=${$} x1=${e.left} x2=${e.width-e.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
            ${i.map(i=>V`
              <stop offset=${`${Math.max(0,Math.min(100,(i.x-e.left)/x*100))}%`} stop-color=${Ft(i,t)}></stop>
            `)}
          </linearGradient>
        </defs>
        ${this._renderGrid(t,e,n,m,l)}
        ${f?V`<line class="price-current-line" x1=${_} x2=${_} y1=${e.top} y2=${h}></line>`:G}
        ${"line"===a?this._renderLineChart(i,h,g,$,t):this._renderBarChart(i,d,u,r,t)}
        ...
        <title>${St(this.hass,r.timestamp)} ${Ct(r.value,t)}</title>
    ...
    `}_renderGrid(t,e,i,r,s){const o=e.height-e.bottom,n=wt(t);return[...Array.from({length:n},(r,s)=>{const a=1-s/(n-1),c=e.top+s/(n-1)*(o-e.top),l=i.min+(i.max-i.min)*a;return V`
        ...
        `}),...r.map((t,i)=>{const n=Mt(t,s,e),a=0===i?" price-time-label-start":i===r.length-1?" price-time-label-end":"";return V`
          ...
          <text class=${`price-time-label${a}`} x=${n} y=${e.height-6}>${function(t,e){return new Intl.DateTimeFormat(t?.locale?.language,{day:"numeric",month:"long",...kt(t)}).format(new Date(e))}(this.hass,t)}</text>
        `})]}_renderBarChart(t,e,i,r,s){return t.map(t=>{const o=Math.min(t.y,e),n=Math.max(1,Math.abs(e-t.y)),a=t.timestamp===r.timestamp?" price-bar-selected":"";return V`
        <rect
          class=${`price-bar${a}`}
          x=${t.x-i/2}
          y=${o}
          ...
          fill=${Ft(t,s)}
        ></rect>
      `})}_renderLineChart(t,e,i,r,s){const o=Pt(t),n=function(t,e){if(!t.length)return"";const i=t[0],r=t[t.length-1];return`${Pt(t)} L ${r.x.toFixed(2)} ${e.toFixed(2)} L ${i.x.toFixed(2)} ${e.toFixed(2)} Z`}(t,e),a=!1===s.use_sensor_colors?s.line_color||"#ffc928":`url(#${r})`;return V`
    ...
    `}_selectPoint(t,e,i,r){const s="hover"===r&&"pointermove"===t.type&&"touch"!==t.pointerType;if("pointermove"===t.type&&!s&&!this._dragging)return;if("pointerdown"===t.type){this._dragging=!0;try{t.currentTarget.setPointerCapture(t.pointerId)}catch{}}t.preventDefault();const o=t.currentTarget.getBoundingClientRect(),n=(t.clientX-o.left)/Math.max(1,o.width)*i.width;let a=0,c=Math.abs(e[0].x-n);e.forEach((t,e)=>{const i=Math.abs(t.x-n);i<c&&(a=e,c=i)}),this._selectedIndex=a}_openMoreInfo(t){t&&ft(this,"hass-more-info",{entityId:t})}}Ut.properties={hass:{attribute:!1},_config:{state:!0},_selectedIndex:{state:!0}},Ut.styles=o`
    :host {
      display: block;
  ...
  `;class Ot extends ct{constructor(){super(...arguments),this._config=Ut.getStubConfig()}setConfig(t){this._config=Nt(t||{})}render(){const t=Nt(this._config);return B`
      <div class="editor">
