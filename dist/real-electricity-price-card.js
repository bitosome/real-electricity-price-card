        ...
        <div class="price-content">
          ...
          <div class="price-chart-frame">
            ...
            <div class="price-chart-body">
              ${this._renderChart(t,o,l,m,f,g,c,r,s,e,$,p)}
              <span
      ...
      >
        <defs>
          ...
          <linearGradient id=${v} x1=${e.left} x2=${e.width-e.right} y1="0" y2="0" gradientUnits="userSpaceOnUse">
            ${i.map(i=>W`
              <stop offset=${`${Math.max(0,Math.min(100,(i.x-e.left)/w*100))}%`} stop-color=${Bt(i,t,h,p)}></stop>
            `)}
          </linearGradient>
        </defs>
        ${this._renderGrid(t,e,o,g,l)}
        ${"line"===a?this._renderLineChart(i,d,y,v,t):this._renderBarChart(i,u,f,m,r,t,h,p)}
